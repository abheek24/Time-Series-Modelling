...
### ARMA Models, Decomposition of Time Series , Looking at trend, seasonality. Autocorrelation test and test for stationarity
...
The data for Part I is contained in the Excel file "time_series_data_updated.xlsx." Each sheet contains one of the 4 different time series to work with.
...
There is no clear indication of trend during the initial period , however the later years shows clear trend when we decompose the time series  
There is clear indication of seasonality when we decompose the time series  
